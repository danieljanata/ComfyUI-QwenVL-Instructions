...
> **Instructions fork**
>
> This repository is a derivative work of the upstream project **ComfyUI-QwenVL**.
> It is distributed under **GPL-3.0-or-later**. See `LICENSE` and `NOTICE.md`.
>
> This fork adds two maintenance-friendly nodes:
> - **QwenVL Model Downloader (Instructions)**
> - **Instructions (Instructions)**
>
> The text inside parentheses helps you identify which addon the node comes from.
...
This repo includes an additional split workflow:
- **QwenVL Model Downloader**: loads the model and outputs `qwen_model`
- **Instructions**: takes `qwen_model` + image/video + free-form instruction text and outputs `RESPONSE`

Install as usual in `ComfyUI/custom_nodes/`.
